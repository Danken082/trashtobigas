...
<body>
  ...
  <script>
    ...
    // Update conversion result automatically when user types a trash weight
          ...
          success: function(response) {
            if (response.status === "success") {
              $("#conversionResult").html(
                `You will earn <strong>${response.points}</strong> points, which equals <strong>${response.riceKilos}</strong> kilo/s of rice!`
              );
            } else {
    ...
    // Existing convertPoints function for when the user clicks the button
